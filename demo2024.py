...
if __name__ == "__main__":
    ...
    guessHeightAboveGround_top = 25
    xMesh, yMesh, zTopo, _ = reconstruct_fantopo.reconstruct_fan_surface(topo_pre_event, xApex, yApex, volume_expected, guessHeightAboveGround_top, guessHeightAboveGround_bottom, fitting_s_z_within_boundary, fanBoundarySHP=shape_fan_boundary, tol=0.03, debug=True)
