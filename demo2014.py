...
if __name__ == "__main__":
    ...
    # System 1: AMD Ryzen 9 5900X, NVIDIA GeForce RTX 3080, PYTHON 3.11
    # 10-meter: 227.4 seconds, 20-meter: 61.3 seconds

    topo_pre_event = r"datasets\raw\tif\topo_PuTunPuNas_min_before2014_riverbed2014_10m.tif"
    topo_post_event = r"datasets\raw\tif\topo_PuTunPuNas_2014_10m.tif"
