...
def testVisilibity():
    ...
    a = observer._in(env,epsilon)

    print('hahahahahahaahahahahahahahahahahaha = ' + str(a))
    # Obtein the visibility polygon of the 'observer' in the environmente
    # previously define
    isovist = vis.Visibility_Polygon(observer, env, epsilon)

    print('hehehehehehehehe' + str(isovist.get_growing_vertices()))
    print(dir(isovist.get_growing_vertices()))
    child_x , child_y  = save_print(isovist.get_growing_vertices())
    print('hohohohohoh_x' + str(child_x))
    print('hohohohohoh_y' + str(child_y))
